...
import { Wallet, TrendingUp, History, ArrowUpRight, ArrowDownRight, AlertCircle, CheckCircle2, Clock } from 'lucide-react';
...
const Finances = () => {
  ...
  return (
    <div className="space-y-10">
      <div>
        <h1 className="text-4xl font-black tracking-tight text-white uppercase">Фінанси</h1>
        <p className="text-zinc-500 mt-2 text-xs font-bold uppercase tracking-[0.2em]">Керування вашими активами</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="bg-black/40 border-white/5 rounded-none shadow-2xl relative overflow-hidden group">
          ...
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em]">Поточний баланс</CardTitle>
        ...
        <Card className="bg-black/40 border-white/5 rounded-none shadow-2xl">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em]">Загальний прибуток</CardTitle>
            <TrendingUp className="h-4 w-4 text-red-700" />
          </CardHeader>
          <CardContent>
            <div className="text-5xl font-black text-white tracking-tighter">
              {totalProfit.toLocaleString()} <span className="text-2xl text-zinc-700">₴</span>
            </div>
            <p className="text-[9px] text-zinc-600 mt-8 font-black uppercase tracking-widest">Сумарно за весь час</p>
          </CardContent>
        </Card>
      </div>
          ...
          <table className="w-full text-left">
            <thead className="bg-white/5 text-[10px] uppercase text-zinc-500 font-black tracking-widest">
              <tr>
                ...
                <th className="px-8 py-5">Сума</th>
            ...
            <tbody className="divide-y divide-white/5">
              {userTransactions.length > 0 ? (
                ...
                <tr>
                  <td colSpan={4} className="px-8 py-20 text-center text-zinc-800 text-[10px] font-black uppercase tracking-widest">
                    Операцій ще не було
                  </td>
                </tr>
              )}
        ...
        <DialogContent className="bg-[#050505] border-white/5 text-white max-w-md rounded-none">
          ...
          <div className="space-y-8 py-6">
            ...
            <div className="space-y-3">
              <Label className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Сума виводу *</Label>
            ...
            <div className="space-y-3">
              <Label className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Контакт для уточнення реквізитів *</Label>
              <Input 
                value={contact}
          ...
          <DialogFooter className="gap-3">
            ...
            <Button 
              ...
              className="bg-red-700 hover:bg-red-800 text-[10px] font-black uppercase tracking-widest px-8 h-12 rounded-none disabled:opacity-30"
            >
              Підтвердити
            </Button>
          </DialogFooter>
