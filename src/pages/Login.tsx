        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input id="login" {...register('login')} className="bg-[#1a1a1a] border-white/10 focus:border-violet-500 h-12" placeholder="name@example.com" />
            </div>
            <div className="space-y-2">
              ...
              <Input id="password" type="password" {...register('password')} className="bg-[#1a1a1a] border-white/10 focus:border-violet-500 h-12" placeholder="••••••••" />
            </div>
          ...
          <div className="text-center space-y-4">
            <p className="text-sm text-gray-500">
              Немає акаунту?{' '}
              <Link to="/register" className="text-violet-500 hover:underline font-medium">Зареєструватися</Link>
            </p>
            <div className="p-4 bg-violet-500/5 border border-violet-500/10 rounded-lg">
              <p className="text-xs text-violet-400 font-mono">Демо: admin / admin2</p>
            </div>
          </div>
        </div>
      </div>
