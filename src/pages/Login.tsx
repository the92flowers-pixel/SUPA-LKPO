      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-12 bg-gradient-to-br from-red-900/20 to-black border-r border-white/5">
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-12">
            ...
            <span className="text-2xl font-bold tracking-tighter">ЖУРБА MUSIC</span>
          </div>
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-400 max-w-md leading-relaxed">Дистрибуція на 150+ стрімінгових платформ. Залишай собі 100% роялті.</p>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            <h1 className="text-3xl font-bold tracking-tight">Ласкаво просимо</h1>
